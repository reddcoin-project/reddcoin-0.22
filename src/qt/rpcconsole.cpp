...
void RPCConsole::setClientModel(ClientModel *model, int bestblock_height, int64_t bestblock_date, double verification_progress)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        setStakingInfo(bestblock_height, QDateTime::fromTime_t(bestblock_date), verification_progress, false);
...
void RPCConsole::setStakingInfo(int count, const QDateTime& blockDate, double nVerificationProgress, bool headers)
{
    if (!clientModel)
	return;
